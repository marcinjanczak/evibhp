<div>
    {{-- Pasek narzędzi: Wyszukiwarka + Przycisk --}}
                    ...
                    @forelse($employees as $employee)
                        <tr>
                            ...
                            <td class="text-end pe-4">
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-light text-primary" title="Historia">
                                        <i class="fas fa-history"></i>
                                    </a>
                                    <button class="btn btn-sm btn-light text-secondary" title="Edytuj">
