                            ...
                            <div class="col-md-4">
                                @if ($item->zdjecie_pogladowe_path)
                                    <img src="{{ Storage::url($item->zdjecie_pogladowe_path) }}"
                                        alt="Zdjęcie przedmiotu {{ $item->nazwa }}" class="img-fluid rounded shadow">
                                @else
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    @if ($item->faktura_pdf_path)
                                        <li class="list-group-item">
                                            <strong>Faktura:</strong> <a href="{{ Storage::url($item->faktura_pdf_path) }}"
                                                target="_blank">Pokaż plik</a>
                                        </li>
                                    @endif
                                </ul>
                            </div>
